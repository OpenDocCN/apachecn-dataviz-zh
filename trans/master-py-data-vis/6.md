...
![Classification methods](graphics/B02085_06_01.jpg)
...
![Understanding linear regression](graphics/B02085_06_02.jpg)
...
![Understanding linear regression](graphics/B02085_06_03.jpg)
...
![Linear regression](graphics/B02085_06_04.jpg)
...
![Linear regression](graphics/B02085_06_05.jpg)
...
![Linear regression](graphics/B02085_06_06.jpg)

如上图所示，蓝点为 *(x，y)* 的观测值，对角交叉的线为基于 *(x，y)* 值的最小二乘拟合，橙色线为残差，为观测值与最小二乘线之间的距离。

![Linear regression](graphics/B02085_06_07.jpg)
...
![Linear regression](graphics/B02085_06_08.jpg)
...
![An example](graphics/B02085_06_09.jpg)
...
![An example](graphics/B02085_06_10.jpg)

为了创建自己的树形结构，可以选择从`matplotlib`开始使用绘图方法。为了显示树形图，`matplotlib`有注释，允许您创建带有标签的树形结构，如以下代码所示:
...
![An example](graphics/B02085_06_11.jpg)
...
![The Bayes theorem](graphics/B02085_06_12.jpg)
...
![The Bayes theorem](graphics/B02085_06_13.jpg)

同样，如果我们知道一个随机选择的人得了癌症，诊断测试出来阳性的概率是多少？这转化为*概率(B 给 A)* ，如下代码所示:

![The Bayes theorem](graphics/B02085_06_14.jpg)
...
![The Naïve Bayes classifier](graphics/B02085_06_15.jpg)

利用红色和蓝色的先验概率，可以计算出 x 为红色或蓝色的后验概率，如下代码所示:

![The Naïve Bayes classifier](graphics/B02085_06_16.jpg)
...
![The Naïve Bayes classifier using TextBlob](graphics/B02085_06_17.jpg)
...
![Viewing positive sentiments using word clouds](graphics/B02085_06_18.jpg)
...
![k-nearest neighbors](graphics/B02085_06_19.jpg)
...
![k-nearest neighbors](graphics/B02085_06_20.jpg)
...
![k-nearest neighbors](graphics/B02085_06_21.jpg)
...
![Logistic regression](graphics/B02085_06_22.jpg)
...
![Logistic regression](graphics/B02085_06_23.jpg)

下面是一个展示*快乐*和*悲伤*概率的例子。

![Logistic regression](graphics/B02085_06_24.jpg)
...
![Logistic regression](graphics/B02085_06_25.jpg)
...
![Support vector machines](graphics/B02085_06_26.jpg)
...
![Support vector machines](graphics/B02085_06_27.jpg)
...
![Principal component analysis](graphics/B02085_06_28.jpg)
...
![Principal component analysis](graphics/B02085_06_29.jpg)
...
![k-means clustering](graphics/B02085_06_30.jpg)

![k-means clustering](graphics/B02085_06_31.jpg)

在这个例子中，如果我们为五个集群设置 *k=5* ，那么这个集群保持不变，但是另外两个集群被分成两个以获得五个集群，如下图所示:

![k-means clustering](graphics/B02085_06_32.jpg)
