...
大多数可视化故事都是从某个问题开始的，这个问题是针对正在探索或收集数据的主题。这个问题包含了故事的前提，并把我们引向数据对故事情节进行考察的点。这样的数据考察以一个问题开始，例如，【2014 年报告了多少埃博拉死亡病例？由一群人通过相互协作来实现。数据传播者的角色应该是创造一种信息体验，改变受众对其故事的看法。
...
![The Ebola example](graphics/B02085_02_01.jpg)
...
![The Ebola example](graphics/B02085_02_02.jpg)
...
![A sports example](graphics/B02085_02_05.jpg)
...
![Visually representing the results](graphics/B02085_02_06.jpg)
...
当剧情( *X，Y* )切换到( *Y，X* )时，有足够的空间显示四分卫的名字。在前面的代码片段中，我们可能需要进行以下更改:

![Visually representing the results](graphics/B02085_02_07.jpg)
...
![Visually representing the results](graphics/B02085_02_08.jpg)

当你看一下标绘结果，只有两个四分卫的成绩能和 35 岁的培顿·曼宁相提并论，那就是德鲁·布里斯和汤姆·布拉迪。然而，考虑到汤姆·布拉迪目前的年龄和他迄今为止的成就，似乎只有德鲁·布里斯更有可能超越培顿·曼宁的触地得分记录。

下图显示了这一结论，并给出了基于 35 岁的简单数据图。对比前四名四分卫的成绩——培顿·曼宁、汤姆·布拉迪、德鲁·布里斯和布雷特·法弗——我们可以看到，德鲁·布里斯在 35 岁时的成就堪比佩顿在同样年龄时的成就。虽然《纽约时报》以标题*为题的文章《为什么培顿·曼宁的记录很难被打破》*得出了不同的结论，但以下情节，至少是倾向于德鲁·布里斯可能打破记录的可能性:

![Visually representing the results](graphics/B02085_02_09.jpg)
...
2010 年，斯坦福大学的研究人员研究并回顾了讲故事的新兴重要性，并为叙事可视化提出了一些设计策略。根据他们的研究，纯作者驱动的方法在可视化中有严格的线性路径，依赖于消息传递，并且没有交互性，而读者驱动的方法没有规定的图像排序，没有消息传递，并且具有高度的交互性。作者驱动方法的一个例子是幻灯片演示。该研究列出的七种可视化叙事包括杂志风格、注释图表、分区海报、流程图、连环画、幻灯片和一部电影/视频/动画。
...
![Gapminder](graphics/B02085_02_10.jpg)
...
![The State of the Union address](graphics/B02085_02_11.jpg)
...
![Mortality rate in the USA](graphics/B02085_02_12.jpg)
...
![Mortality rate in the USA](graphics/B02085_02_13.jpg)
...
![Author-driven narratives](graphics/B02085_02_14.jpg)
...
![Author-driven narratives](graphics/B02085_02_15.jpg)
...
![Author-driven narratives](graphics/B02085_02_16.jpg)
...
*   **Proximity**: Objects that are close together or connected to each other are perceived as a group, reducing the need to process smaller objects separately.
    ...
    ![The Gestalt principles of perception](graphics/B02085_02_17.jpg)

*   **Similarity**: Objects that share similar attributes, color, or shape are perceived as a group.

    ![The Gestalt principles of perception](graphics/B02085_02_18.jpg)
...
*   **Common fate**: When both the principles of proximity and similarity are in place, a movement takes place. Then they appear to change grouping.
    ...
    ![The Gestalt principles of perception](graphics/B02085_02_19.jpg)
...
*   **Good continuation**: Some things are important as a whole, which means if there are interruptions, then it changes the perceptive reading. In the following image, we perceive the two crossed lines instead of four lines meeting at the center:
    ...
    ![The Gestalt principles of perception](graphics/B02085_02_20.jpg)
...
*   **Closure**: Even if a part of the border of a shape is missing, we still tend to see the shape as completely enclosed by the border and ignore the gaps.
    ...
    ![The Gestalt principles of perception](graphics/B02085_02_21.jpg)

了解这些原则对于创建任何可视化方法都非常有用。

让我们用一个例子来进一步阐述。邻近是指如果形状看起来彼此相似，则将形状分组在一起的视觉方法。这样的群体通常被视为一个单一的单位。例如，下图显示了如何区分邻近关系:

![The Gestalt principles of perception](graphics/B02085_02_35.jpg)
...
![Comparison and ranking](graphics/B02085_02_22.jpg)
...
![Correlation](graphics/B02085_02_23.jpg)
...
![Distribution](graphics/B02085_02_26.jpg)
...
![Distribution](graphics/B02085_02_27.jpg)
...
![Location-specific or geodata](graphics/B02085_02_28.jpg)

## 部分对整体的关系

饼图是显示部分到整体关系的常用工具，但也有其他方法。分组条形图有利于将类别中的每个元素与其他元素进行比较，也有利于跨类别比较元素。然而，分组使得区分每组总数之间的差异变得更加困难。这就是堆叠柱形图的由来。

![Part-to-whole relationships](graphics/B02085_02_29.jpg)
...
![Trends over time](graphics/B02085_02_30.jpg)
...
![Canopy from Enthought](graphics/B02085_02_03.jpg)
...
![Anaconda from Continuum Analytics](graphics/B02085_02_04.jpg)
...
![Circular layout](graphics/B02085_02_32.jpg)

例如，如上图所示，在有限的空间内显示复杂的关系是很直观的。

![Circular layout](graphics/B02085_02_33.jpg)
...
![Balloon layout](graphics/B02085_02_34.jpg)
