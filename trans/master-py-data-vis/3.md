...
![IPython](graphics/B02085_03_03.jpg)
...
![Plotly](graphics/B02085_03_04.jpg)
...
![PyCharm](graphics/B02085_03_05.jpg)

极坐标投影可以快速完成，如前面的截图所示，随机样本数组的创建如下面的截图所示:

![PyCharm](graphics/B02085_03_06.jpg)
...
![PyDev](graphics/B02085_03_07.jpg)
...
![Interactive Editor for Python (IEP)](graphics/B02085_03_10.jpg)
...
![Canopy from Enthought](graphics/B02085_03_01.jpg)
...
![Canopy from Enthought](graphics/B02085_03_08.jpg)
...
![Canopy from Enthought](graphics/B02085_03_09.jpg)
...
![Canopy from Enthought](graphics/B02085_03_11.jpg)
...
![Anaconda from Continuum Analytics](graphics/B02085_03_02.jpg)
...
![An overview of Spyder](graphics/B02085_03_12.jpg)
...
1.  First, generate the *X* and *Y* grid with the following code:
    ...
    ![The surface-3D plot](graphics/B02085_03_13.jpg)
...
![The square map plot](graphics/B02085_03_14.jpg)
...
我们不会详细说明这个工具。你可以在[http://bokeh.pydata.org](http://bokeh.pydata.org)阅读和探索更多相关内容。然而，重要的是要知道 Bokeh 库的依赖关系。安装博克库前，要求安装`jsonschema`，如下:
