...
![Gross returns](graphics/B02085_05_01.jpg)
...
![Gross returns](graphics/B02085_05_04.jpg)
...
![Gross returns](graphics/B02085_05_05.jpg)
...
![Gross returns](graphics/B02085_05_21.jpg)
...
![Gross returns](graphics/B02085_05_20.jpg)
...
![Gross returns](graphics/B02085_05_23.jpg)
...
![Gross returns](graphics/B02085_05_26.jpg)
...
![What exactly is Monte Carlo simulation?](graphics/B02085_05_06.jpg)

让我们看看概率模型和确定性模型有什么不同。

随机模型的输入是概率性的，来自概率密度函数，产生的结果也是概率性的。随机模型是这样的:

![What exactly is Monte Carlo simulation?](graphics/B02085_05_07.jpg)
...
![An inventory problem in Monte Carlo simulation](graphics/B02085_05_08.jpg)
...
![An inventory problem in Monte Carlo simulation](graphics/B02085_05_09.jpg)

前面的图是对数刻度上显示的，这意味着 *n=1000* 的模拟运行的最大利润是 119.4。现在，让我们试着看一下解析解，看看模拟结果与解析方法的结果有多接近。

由于需求( *D* )在【80，140】中均匀分布，预期利润由以下积分得出:

![An inventory problem in Monte Carlo simulation](graphics/B02085_05_10.jpg)
...
![Monte Carlo simulation in basketball](graphics/B02085_05_11.jpg)

前面的截图显示了勒布朗的三分和两分尝试。以下剧情展示了其他四位玩家的尝试进行对比:

![Monte Carlo simulation in basketball](graphics/B02085_05_12.jpg)

### 波动图

到目前为止，我们已经看到了许多有用的 Python 包。一次又一次，我们看到了 matplotlib 的使用，但在这里，我们将用很少的代码行展示熊猫的使用，这样您就可以快速实现财务情节。标准差是一个统计术语，用来衡量平均值周围的变化量或离差。这也是衡量波动性的一个指标。
...
![The volatility plot](graphics/B02085_05_13.jpg)
...
![The volatility plot](graphics/B02085_05_16.jpg)
...
![The volatility plot](graphics/B02085_05_18.jpg)
...
![Implied volatilities](graphics/B02085_05_14.jpg)

![Implied volatilities](graphics/B02085_05_15.jpg)
...
![Implied volatilities](graphics/B02085_05_17.jpg)
...
![Implied volatilities](graphics/B02085_05_19.jpg)
...
![Implied volatilities](graphics/B02085_05_22.jpg)
...
![The portfolio valuation](graphics/B02085_05_27.jpg)
...
![The portfolio valuation](graphics/B02085_05_28.jpg)
...
![Geometric Brownian simulation](graphics/B02085_05_29.jpg)

综合双方，应用初始条件:*S*<sub>*t*</sub>*= S*<sub>*o*</sub>，可以得出上述方程的解如下:

![Geometric Brownian simulation](graphics/B02085_05_30.jpg)
...
![Geometric Brownian simulation](graphics/B02085_05_31.jpg)
...
![Geometric Brownian simulation](graphics/B02085_05_32.jpg)
...
![The diffusion-based simulation](graphics/B02085_05_33.jpg)

*x* <sub>*t*</sub> 的值具有卡方分布，但是在离散版本中，它们可以用正态分布来近似。对于离散版本，我们指的是使用迭代方法应用欧拉数值近似方法，如下式所示:

![The diffusion-based simulation](graphics/B02085_05_34.jpg)
...
![The diffusion-based simulation](graphics/B02085_05_35.jpg)
...
![Schelling's Segregation Model](graphics/B02085_05_24.jpg)
...
![K-nearest neighbors](graphics/B02085_05_25.jpg)
...
![Generalized linear models](graphics/B02085_05_36.jpg)
...
![Bayesian linear regression](graphics/B02085_05_37.jpg)
...
![Bayesian linear regression](graphics/B02085_05_38.jpg)

![Bayesian linear regression](graphics/B02085_05_39.jpg)
...
![Creating animated and interactive plots](graphics/B02085_05_40.jpg)

Plotly 是另一个允许互动剧情的选项，但是需要一个在线并且有 Plotly 账号。使用 Plotly 的情节看起来非常好，而且是交互式的。以下代码显示了如何使用`plotly`创建交互式绘图:
...
![Creating animated and interactive plots](graphics/B02085_05_41.jpg)
...
![Creating animated and interactive plots](graphics/B02085_05_42.jpg)

前面的图像显示了第一次出现的图，但是当我们移动鼠标并放大它时，它显示如下:

![Creating animated and interactive plots](graphics/B02085_05_43.jpg)
