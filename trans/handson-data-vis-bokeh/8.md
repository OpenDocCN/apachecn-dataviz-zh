...
当谈到从头开始构建自己的Bokeh可视化时，一个很好的开发实践是永远不要从Bokeh开始。相反，理想的方法是首先对您的数据进行一些探索性的分析，以便可视化您可以使用 Bokeh 创建的能够为您的用户提供最大价值的应用程序。
...
这本书到此结束！我希望这本书给了你一个丰富的，对Bokeh世界的实际介绍！我希望你能继续利用你在这里学到的技能，制作出能吸引广大观众的互动绘图！