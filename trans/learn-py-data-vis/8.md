...
![Installing the matplotlib library](images/3334OS_08_01.jpg)
...
![Creating simple matplotlib charts](images/3334OS_08_03.jpg)
...
![Creating simple matplotlib charts](images/3334OS_08_04.jpg)

在**保存**按钮旁边的中可以找到的控件之一是**支线剧情配置工具**。单击打开控件子集以调整图表，如下图所示:

![Creating simple matplotlib charts](images/3334OS_08_15.jpg)
...
![Creating simple matplotlib charts](images/3334OS_08_07.jpg)

带`matplotlib`的 3D 图表的一个大特点是我们可以用鼠标旋转 3D 图表，通过将鼠标拖动到图表图像上；下面是一个更新图表的例子，以获得更好的点和曲线角度:

![Creating simple matplotlib charts](images/3334OS_08_08.jpg)
...
![Plotly](images/3334OS_08_09.jpg)
...
![Plotly](images/3334OS_08_10.jpg)
...
![Plotly](images/3334OS_08_11.jpg)
...
![Plotly](images/3334OS_08_12.jpg)
...
![Plotly](images/3334OS_08_13.jpg)
